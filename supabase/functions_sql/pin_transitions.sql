...
-- vit dans `supabase/migrations/0001_socle.sql` puis
-- `20260921140832_trace_toutes_transitions.sql` (Postgres n'a pas de mécanisme
...
-- spine. Toute modification de ces fonctions doit être faite dans une
-- migration d'abord, puis recopiée ici à l'identique.
